document.addEventListener("DOMContentLoaded", () => {
    ...
    const spinner = submitButton ? submitButton.querySelector(".spinner");
    const btnText = submitButton ? submitButton.querySelector(".btn-text");

    // Гарантированно глушим окно успеха на старте
    if (successUI) {
